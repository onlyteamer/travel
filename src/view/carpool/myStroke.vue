        ...
        <div v-for="index in 3" v-if="strokeType != '0'">
            <div class="listInfo">
                ...
                <van-row style="margin: 10px 0">
                    ...
                    <van-col span="6">
                        <van-button type="default" color="#0CC893" style="font-size: 14px;width: 96%;height: 28px" size="mini" @click="showPopup = true">取消行程</van-button>
                    </van-col>
                </van-row>
            </div>
            ...
            <div class="popInfo">
                ...
                <van-row>
                    <van-col span="6" offset="18">
                        <van-button type="default" color="#0CC893" style="font-size: 14px;width: 96%;height: 28px" size="mini">乘客</van-button>
                    </van-col>
                </van-row>
            </div>
        </div>
